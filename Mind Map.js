{
	"translatorID": "e4ce05b1-92e2-4046-800c-50219140b675",
	"label": "Mind map",
	...
	"inRepository": false,
	"translatorType": 2,
	"lastUpdated": "2016-11-06 22:00:00"
}
...
function doExport() {
    ...
    */
    ...
    /* Output */
	//Zotero.write(JSON.stringify(collections, null, 4)); /* working json */

	var xmlAsStr = x2js.json2xml_str( JSON.stringify(collections) );
	Zotero.write( xmlAsStr );
}											
